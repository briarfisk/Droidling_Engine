...
public:
     ...
     float settings_Input_Charging_Depth;
     ...
     //To use the charge spike, or not.
     int setting_Charge_Spike;
     
     //Whether or not to put all the outputs onto a single row given multiple input cells.
     int setting_Flat_Output;
     ...
     ~c_NT3_Poly_Construct_1D()
     {
          cout << "\n  ~c_NT3_Poly_Construct_1D " << Name << " " << this << ".........."; cout.flush();
     ...
     void charge_Buffer_RC_R(int p_Input)
     {
          ...
          for (int cou_T=settings_Tier;cou_T<Input_Depth;cou_T++)
          {
               ...
               if ((p_Input - cou_T) >= 0 && (CAN.CAN[cou_T] [p_Input - cou_T] != NULL)){ Charging_Buffers[p_Input].submit(CAN.CAN[cou_T] [p_Input - cou_T]); }
     ...
     void discharge_Treetops_L(int p_Input)
     {
          ...
          while(tmp_LL != NULL)
          {
               ...
               Nodes.bp(&tbl_Pattern_Output_L, setting_Flat_Output, Current_Input, tmp_LL->NID);
     ...
     void discharge_Treetops_R(int p_Input)
     {
          ...
          while(tmp_LL != NULL)
          {
               ...
               Nodes.bp(&tbl_Pattern_Output_R, setting_Flat_Output, Current_Input, tmp_LL->NID);
     ...
     void discharge_Treetop_By_NID_L(int p_Position, u_Data_3 p_NID, u_Data_3 p_Charge, int p_Current_Input)
     {
          ...
          tmp_Node = Nodes.bp_Treetop(&tbl_Pattern_Output_L, setting_Flat_Output, p_Current_Input, p_NID);
     ...
     void discharge_Treetop_By_NID_R(int p_Position, u_Data_3 p_NID, u_Data_3 p_Charge, int p_Current_Input)
     {
          ...
          tmp_Node = Nodes.bp_Treetop(&tbl_Pattern_Output_R, setting_Flat_Output, p_Current_Input, p_NID);
     ...
     void Save(string p_Name = "NO_NAME", string p_Dir = "NT3.Save/")
     {
          ...
          //The tier to start charging.
          SF << "\nsettings_Tier_Floating " << settings_Tier_Floating;
          ...
          SF << "\nsetting_Flat_Output " << setting_Flat_Output;
     ...
     void Load(string p_Name, string p_Dir = "NT3.Save/")
     {
          ...
          LF >> tmp_Setting_Name;
          cout << "\n" << tmp_Setting_Name;
          LF >> settings_Tier_Floating;
          cout << " " << settings_Tier_Floating;
          ...
          LF >> tmp_Setting_Name;
          cout << "\n" << tmp_Setting_Name;
          LF >> setting_Flat_Output;
          cout << " " << setting_Flat_Output;
