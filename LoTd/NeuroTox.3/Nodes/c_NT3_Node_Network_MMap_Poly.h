...
class c_NT3_NodeDB_Poly_Header_Poly
{
public:
...
public:
     ...
     //The databse header.
     c_NT3_NodeDB_Poly_Header_Poly NodeDB_Header;
     ...
     c_NT3_NodeDB_Node_Poly current_Node;
...
class c_NT3_Node_Network_MMap_Poly
{
private:
...
public:
     ...
     c_NT3_NodeDB_Poly Nodes;
     
     //For all node operations query c_NT3_NodeDB_Poly
     ...
     ~c_NT3_Node_Network_MMap_Poly()
     {
          cout << "\n ~c_NT3_Node_Network_MMap_Poly " << CNID.I << " " << this << ".........."; cout.flush();
          //delete Root;
